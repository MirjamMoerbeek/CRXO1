...
f.var2a=function(mm,kk,eta,rho,xi,pp.AB,pp.BA)  # attrition of subjects, replace those who drop out by others from the same clusters
{
  pp=pp.AB	# proportion attrition in second time period in each cluster in sequence AB
  nn=round(mm*pp-1)
  ...
  offdiag.mat=matrix(eta,mm,mm)
  diag(offdiag.mat)=xi
  offdiag.mat[(mm-nn):mm,(mm-nn):(mm)]=eta
...
f.var3a=function(mm,kk,eta,rho,xi,pp.AB,pp.BA,ff)
{
  
  # ff = proportion extra subjects in second time period in those clusters that do not drop out
  ...
  diag.mat1=matrix(rho,mm1,mm1)
  diag(diag.mat1)=1
  offdiag.mat1=matrix(eta,mm1,mm1)
  diag(offdiag.mat1)=xi
  offdiag.mat1=cbind(offdiag.mat1,matrix(eta,mm1,mm2-mm1))
  
  diag.mat2=matrix(rho,mm2,mm2)
  diag(diag.mat2)=1
  offdiag.mat2=matrix(eta,mm1,mm1)
  diag(offdiag.mat2)=xi
  offdiag.mat2=rbind(offdiag.mat2,matrix(eta,mm2-mm1,mm1))
  
  VV.upper=cbind(diag.mat1,offdiag.mat1)
  VV.lower=cbind(offdiag.mat2,diag.mat2)
  VV=rbind(VV.upper,VV.lower)
  
  XXab=matrix(0,mm1+mm2,3)
  XXab[,1]=1
  XXab[(mm1+1):(mm1+mm2),2:3]=1
  
  XXba=matrix(0,mm1+mm2,3)
  XXba[,1]=1
  XXba[1:mm,3]=1
  XXba[(mm1+1):(mm1+mm2),2]=1
...
f.var5a=function(mm,kk,eta,rho,pp.AB,pp.BA,ff)
{
  ...
  diag.mat1=matrix(rho,mm1,mm1)
  diag(diag.mat1)=1
  offdiag.mat1=matrix(eta,mm1,mm2)
  
  diag.mat2=matrix(rho,mm2,mm2)
  diag(diag.mat2)=1
  offdiag.mat2=matrix(eta,mm2,mm1)
